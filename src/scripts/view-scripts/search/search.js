        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
                        throw new Error("HTTP error occured. Status: ".concat(response.status));
                    }
...
function displayImages(data) {
    return __awaiter(this, void 0, void 0, function () {
        var maxLength, fragment;
        return __generator(this, function (_a) {
            maxLength = 10;
            fragment = document.createDocumentFragment();
            data.forEach(function (image) {
                var name = image.image_name, source = image.file_source;
                var searchResult = document.createElement("div");
                searchResult.classList.add("search-result");
                // If the image name or artist name is too long, truncate it and add an ellipsis.
                var truncatedName = name.length > maxLength
                ...
                // Create image element and append it to the search result.
                ...
                var interactHolder = document.createElement("div");
...
searchInput.addEventListener("input", function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, fetch("http://localhost:3000/api/search/".concat(input))];
            case 1:
                response = _a.sent();
                return [4 /*yield*/, response.json()];
            case 2:
